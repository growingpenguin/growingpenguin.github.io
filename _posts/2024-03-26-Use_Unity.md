...
-Zoom Tool <br/> 
To zoom in or out on an object, use the zoom tool <br/> 
Click the zoom tool and select the Cube in the Hierarchy window <br/> 
Then, a line with a square end appears on the cube. By dragging the square, you can zoom in or out on the object in one direction along the axis. Dragging the square outward will enlarge the scale, while dragging it inward will reduce the scale. If you drag the square at the center of the cursor, you can zoom in or out simultaneously in the X, Y, and Z directions.
