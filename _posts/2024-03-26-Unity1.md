---
layout: post
title:  "Game Production Preparation"
---

# Game Production Preparation
## Make a Project
...
![Use_Unity_Hands_on37](https://github.com/growingpenguin/growingpenguin.github.io/assets/110277903/f15f5250-d91e-48f2-a7b0-32ae5e0b6207) <br/>
...
At this time, if you drag the circle <br/> 
The red line rotates around the X-axis, the green line rotates around the Y-axis, and the blue line rotates around the Z-axis <br/> 
When you rotate an object, the Rotation value in the Transform section of the Inspector window changes as well <br/> 
Similar to Position, you can change the value to rotate the object <br/> 
-Scale Tool <br/> 
![Use_Unity_Hands_on38](https://github.com/growingpenguin/growingpenguin.github.io/assets/110277903/7da30401-06da-4243-91a3-30ca6b5f6ffa) <br/> 
To scale in or out on an object, use the scale tool <br/> 
Click the zoom tool and select the Cube in the Hierarchy window <br/> 
![Use_Unity_Hands_on39](https://github.com/growingpenguin/growingpenguin.github.io/assets/110277903/45737cd8-0310-49d8-b1d6-0e3b1c7678a1) <br/> 
Then, a line with a square end appears on the cube. By dragging the square, you can zoom in or out on the object in one direction along the axis <br/
Dragging the square outward will enlarge the scale, while dragging it inward will reduce the scale <br/
If you drag the square at the center of the cursor, you can zoom in or out simultaneously in the X, Y, and Z directions <br/>
-Other Features <br/>
Introduces various other features of Unity <br/>
-Layout Change <br/>
You can change the layout of the Unity Editor <br/>
Choose the desired layout from the dropdown list of Layout located at the top right of the editor <br/>
Types of layout: 2 by 3, 4 Split, Default, Tall, Wide <br/>
2 by 3 layout <br/>
![Use_Unity_Hands_on40](https://github.com/growingpenguin/growingpenguin.github.io/assets/110277903/832cdebf-efd1-4af0-838b-f8f87a9c2c7e) <br/>
4 Split layout <br/>
![Use_Unity_Hands_on41](https://github.com/growingpenguin/growingpenguin.github.io/assets/110277903/6e98eb90-f599-49ea-945e-45ef718e4d8b) <br/>
Changing the Size of the Game Play Screen <br/>
Game > Free Aspect <br/>
![Use_Unity_Hands_on42](https://github.com/growingpenguin/growingpenguin.github.io/assets/110277903/4d14fc06-1d9c-4ea4-b120-fef036e6e2d2)
You can select the screen ratio (Aspect Ratio) from the list located at the top left of the Game view <br/>
If you are making a game for iPhone or Android, select the screen size that fits the device <br/>
The range displayed by the camera is set according to the selected screen size <br/>
Example: Full HD <br/>
![Use_Unity_Hands_on43](https://github.com/growingpenguin/growingpenguin.github.io/assets/110277903/ccff37d7-bcbd-466c-9905-008ac55435cf) <br/>
Profiler <br/>
![Use_Unity_Hands_on44](https://github.com/growingpenguin/growingpenguin.github.io/assets/110277903/8c0c7f8a-ae9f-45f5-953e-aa43a9b1677b) <br/>
When running the game, the Profiler can be viewed by clicking on the Status located at the top right of the Game view <br/>
It allows you to check FPS, the number of drawing polygons, the number of batches, and the number of draw calls, among others <br/>
This feature is often used for analysis as the number of elements to process increases in 3D games <br/>
![Use_Unity_Hands_on45](https://github.com/growingpenguin/growingpenguin.github.io/assets/110277903/e84b9839-b7d2-43a7-a4fc-574a81bb7d23) <br/>
The profiler can be examined in detail with a dedicated profiler. Select Window -> Analysis -> Profiler to open the Profiler window <br/>
-Unity 2D and Unity 3D <br/>
Unity provides an environment not only for 3D but also for creating 2D games <br/>
They are not completely different tools <br/>
A 2D game is similar to viewing a 3D game from the side <br/>
Three characteristics of 2D <br/>
-It's like viewing 3D from the side <br/>
-The camera uses parallel projection (objects do not change in size as they move away from the camera) <br/>
-Light effects are disabled (lights are not used in 2D) <br/>
...
Assets 스토어에서 무료 버전 끌고 오기 <br/>
위, 앞, 뒤 대각선 방향 <br/>
https://assetstore.unity.com/3d/props <br/>


파란색: 파란색 면 위주로 해서 위 아래 좌 우 왔다갔다만 보임 <br/>
초록색: 위 아래는 안 가고 똑같이 zoom in out <br/>
빨강색: 세로 고정, 위 아래 왔다갔다 <br/>
